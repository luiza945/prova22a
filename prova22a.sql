...
INSERT INTO Livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma) VALUES 
('As Cronicas de Narnia', 'C.S Lewis', 1950, TRUE, 'Fantasia', '978-0064471190', 'HapperCollins', 768, 'Francês');
UPDATE Livros disponivel FALSE '1980' DESC;
DELETE FROM livros WHERE ingles ='<1980';
SELECT * FROM livro
WHERE pagina = 650;
SELECT categoria, count AS livros FROM group by categorias;
SELECT * FROM livros LIMIT  5;
SELECT * FROM livros
where titulo LIKE 'S%' and  ano_publicacao between'1975' and '1990';